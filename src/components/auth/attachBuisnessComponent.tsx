...
const AttachBuisnessComponent = () => {
  const {handleLinkGoogleBuisnessAccount} = useAuth();
  ...
  return (
    <div className='flex flex-col pb-6 justify-between  items-center'>
      ...
      <Button className='w-full mt-6' onClick={handleLinkGoogleBuisnessAccount}><GoogleIcon/> Link Google Business Account</Button>
