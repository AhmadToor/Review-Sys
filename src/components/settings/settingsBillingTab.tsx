    ...
    <div className="grid grid-cols-[4fr_5fr] gap-6">
      <div className="flex flex-col gap-6">
        ...
        <CardContent className="p-0 flex mb-4 flex-row gap-2">
            <div onClick={()=>{setIsFreetrial(true)}} className={`border-[1px] w-full rounded-3xl p-3 px-4 cursor-pointer  flex flex-col h-20 justify-end     ${isfreetrial && ("border-gradient bg-dashboard1 ")}`}>
                <p className="text-[10px] text-gray-500">Current Plan</p>
                <h1 className="font-semi-bold text-sm">30 Days Free Trial</h1>
            </div>
            <div onClick={()=>{setIsFreetrial(false)}}  className={`border-[1px] w-full  rounded-3xl p-3 px-4   cursor-pointer flex flex-col h-20 justify-end ${!isfreetrial && ("border-gradient bg-dashboard2 ")} `}>
